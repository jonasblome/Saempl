...
SampleFileFilterRuleLoudness& BlomeFileFilterRuleViewLoudness::getLinkedFilterRule()
{
    return *dynamic_cast<SampleFileFilterRuleLoudness*>(&linkedFilterRule);
}
