...
const int TABLE_PANEL_HEIGHT = 500;

const int SAMPLE_PANEL_TOGGLE_HEIGHT = 20;

const int SAMPLE_PANEL_WIDTH = CENTER_PANEL_WIDTH;
const int SAMPLE_PANEL_HEIGHT = CENTER_PANEL_HEIGHT - TABLE_PANEL_HEIGHT - SAMPLE_PANEL_TOGGLE_HEIGHT;

const int SAMPLE_CONTROL_WIDTH = 85;
const int SAMPLE_CONTROL_HEIGHT = SAMPLE_PANEL_HEIGHT;
