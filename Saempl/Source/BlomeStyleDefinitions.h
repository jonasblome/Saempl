...
int const SAMPLE_NAVIGATION_PANEL_WIDTH = CENTER_PANEL_WIDTH;
int const SAMPLE_NAVIGATION_PANEL_HEIGHT = 500;

int const SAMPLE_ITEM_PANEL_TOGGLE_HEIGHT = 20;

int const SAMPLE_ITEM_PANEL_WIDTH = CENTER_PANEL_WIDTH;
int const SAMPLE_ITEM_PANEL_HEIGHT = CENTER_PANEL_HEIGHT - SAMPLE_NAVIGATION_PANEL_HEIGHT - SAMPLE_ITEM_PANEL_TOGGLE_HEIGHT;
