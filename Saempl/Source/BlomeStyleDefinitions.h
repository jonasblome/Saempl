...
struct BlomeStyling
{
    using Ptr=SharedResourcePointer<BlomeStyling>;
    ...
    int const SAMPLE_FAVOURITES_PANEL_HEIGHT = CENTER_PANEL_HEIGHT;
    
    int const SAMPLE_NAVIGATION_PANEL_WIDTH = CENTER_PANEL_WIDTH - SAMPLE_FAVOURITES_PANEL_WIDTH;
    ...
    CENTER_PANEL_HEIGHT
    - SAMPLE_NAVIGATION_PANEL_HEIGHT
    ...
    Colour const COLOUR_ACCENT_MEDIUM = Colour(69, 100, 113); // 71, 24, 19 // 18, 44, 55 // 15, 71, 82 // 80, 97, 74
