...
private:
    String mCurrentFilePath = EMPTY_TILE_PATH;
    String mOldFilePath = EMPTY_TILE_PATH;
    String mTitle = EMPTY_TILE_PATH;
    float mLength = 0;
    float mLoudnessDecibel = MINIMUM_LOUDNESS;
    float mLoudnessLUFS = MINIMUM_LOUDNESS;
    float mDynamicRangeLUFS = 0;
    float mZeroCrossingRate = 0;
    float mSpectralCentroid = 0;
    float mSpectralSpread = 0;
    float mSpectralRolloff = 0;
    float mSpectralFlux = 0;
    float mChromaFlux = 0;
    int mSampleRate = 0;
    int mTempo = 0;
