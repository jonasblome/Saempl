...
private:
    ...
    constexpr static const float radiusDecay = 0.99;
    ...
    Array<std::vector<float>> filterHorizontallyWrap(Array<std::vector<float>>& inGrid, int rows, int columns, int numDimensions, int filterSize);
    Array<std::vector<float>> filterVerticallyWrap(Array<std::vector<float>>& inGrid, int rows, int columns, int numDimensions, int filterSize);
    ...
    Array<std::vector<float>> filterHorizontallyMirror(Array<std::vector<float>>& inGrid, int rows, int columns, int numDimensions, int filterSize);
    Array<std::vector<float>> filterVerticallyMirror(Array<std::vector<float>>& inGrid, int rows, int columns, int numDimensions, int filterSize);
    ...
    int findSwapPositions(Array<int>& swapIndices, Array<int>& swapPositions, int swapAreaWidth, int swapAreaHeight, int rows, int columns);
